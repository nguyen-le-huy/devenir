...
// Code used Suspense fallback={null}. I'll keep it imported if needed or remove if unused. 
// It was imported in original file.

// Lazy load heavy interactive components
const Search = lazy(() => import("@/features/products/components/Search/Search"));
const Bag = lazy(() => import("@/features/cart/components/Bag/Bag"));
...
const Header = memo(() => {
    ...
    const bagTimeoutRef = useRef<ReturnType<typeof setTimeout> | null>(null);
    const topBarRef = useRef<HTMLDivElement>(null);

    // Fetch categories using React Query
    // TODO: Define strict types for useCategories return
    const { data: categoriesData } = useCategories() as any;

    // Sort and memoize categories
    const categories = useMemo(() => {
        if (!categoriesData?.data) return [];
        return [...categoriesData.data].sort((a: any, b: any) =>
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            import("@/features/cart/components/Bag/Bag");
        }, 2000);
    ...
    const preloadSearch = useCallback(() => {
        import("@/features/products/components/Search/Search");
    }, []);

    // Preload triggered via mouse enter on bag icon?
    // It seems preloadBag defined but not used in JSX in original file (except maybe implicitly?)
    // Originally: const preloadBag ... and import Bag in useEffect.
            ...
            <div className={`${styles.topBar} container`} ref={topBarRef}>
                ...
                <div className={styles.right}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M11.4999 3C9.81525 5.69961 8.92212 8.81787 8.92212 12C8.92212 15.1821 9.81525 18.3004 11.4999 21M12.4999 3C14.1846 5.69961 15.0777 8.81787 15.0777 12C15.0777 15.1821 14.1846 18.3004 12.4999 21" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
            ...
            <div className={`${styles.header} container`}>
                <div className={styles.menu}>
                    ...
                    <ul className={styles.links}>
                        {/* Render only first 5 categories from API */}
                        ...
                        {/* Link All navigates to all categories */}
                        <li
                            className={styles.link}
                ...
                <div className={styles.actions}>
                    ...
                    <div className={styles.bagWrapper} onMouseEnter={handleBagIconMouseEnter} onMouseLeave={handleBagIconMouseLeave}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" fill="none" className={styles.bagIcon} onClick={() => bagCount > 0 && navigate('/checkout')} style={{ cursor: bagCount > 0 ? 'pointer' : 'default' }}>
                            <path d="M10 15V10C10 8.67392 10.5268 7.40215 11.4645 6.46447C12.4021 5.52678 13.6739 5 15 5C16.3261 5 17.5979 5.52678 18.5355 6.46447C19.4732 7.40215 20 8.67392 20 10V15" stroke="black" strokeLinecap="round" strokeWidth="1.5" />
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" fill="none" className={styles.menuIcon} onClick={handleOpenMenu}>
                        <path d="M6.66663 10.8333H23.3333M6.66663 15H23.3333M6.66663 19.1667H23.3333" stroke="black" strokeWidth="1.38889" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </div>
                <div className={`${styles.overlayMenu} ${isMenuOpen ? styles.show : ''} container`}>
                    <div className={styles.overlayTop}>
                        <div className={styles.overlayTopHeader}>
                            <a href="/">Home</a>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none" className={styles.closeIcon} onClick={handleCloseMenu}>
                                <path d="M7.99999 22.885L7.11499 22L14.115 15L7.11499 7.99999L7.99999 7.11499L15 14.115L22 7.11499L22.885 7.99999L15.885 15L22.885 22L22 22.885L15 15.885L7.99999 22.885Z" fill="#0E0E0E" />
                            </svg>
                        </div>

 ...
 */
export const getCroppedImageBase64 = (imageElement: HTMLImageElement | null, cropArea: Crop | null, fallbackImage: string | null): string | null => {
    if (!imageElement || !cropArea || !fallbackImage) {
 ...
 */
export const calculateInitialCrop = (width: number, height: number): Crop => {

...
const Devi = ({ width, height }: DeviProps) => {
    return (
        <svg width={width} height={height} viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <filter id="filter0_f_377_447" x="0" y="0" width="110" height="110" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <feGaussianBlur stdDeviation="10" result="effect1_foregroundBlur_377_447">
                        <animate attributeName="stdDeviation" values="10;15;10" dur="2s" repeatCount="indefinite" />
                    </feGaussianBlur>
                </filter>
                ...
                <radialGradient id="paint4_radial_377_447" cx="0" cy="0" r="1" style={{ transformOrigin: "33.7535px 52.3316px" }} gradientUnits="userSpaceOnUse" gradientTransform="matrix(25.0325 15.9694 -12.8062 27.8436 33.7535 52.3316)">
                ...
                <g clipPath="url(#paint0_angular_377_447_clip_path)">
                    <g transform="matrix(0 0.035 -0.035 0 55 55)">
                        <foreignObject x="-1028.57" y="-1028.57" width="2057.14" height="2057.14">
                            <div style={{ background: 'conic-gradient(from 90deg, rgba(123, 15, 80, 1) 0deg, rgba(65, 18, 66, 1) 112.92deg, rgba(255, 23, 23, 1) 360deg)', height: '100%', width: '100%', opacity: 0.4 }}></div>
                        </foreignObject>
                    </g>
                </g>
                <circle cx="55" cy="55" r="35">
            ...
            <g filter="url(#filter1_f_377_447)">
                <g clipPath="url(#paint1_angular_377_447_clip_path)">
                    <g transform="matrix(0 0.035 -0.035 0 55 55)">
                        <foreignObject x="-1028.57" y="-1028.57" width="2057.14" height="2057.14">
                            <div style={{ background: 'conic-gradient(from 90deg, rgba(123, 15, 80, 1) 0deg, rgba(65, 18, 66, 1) 112.92deg, rgba(255, 23, 23, 1) 360deg)', height: '100%', width: '100%', opacity: 0.8 }}></div>
                        </foreignObject>
                    </g>
                </g>
                <circle cx="55" cy="55" r="35">
                ...
                <g clipPath="url(#paint11_angular_377_447_clip_path)">
                    <g transform="matrix(0.0165461 -0.0355017 0.037338 0.017402 55.3503 57.4499)">
                        <foreignObject x="-985.378" y="-985.378" width="1970.76" height="1970.76">
                            <div style={{ background: 'conic-gradient(from 90deg, rgba(250, 168, 170, 0.9687) 0deg, rgba(255, 173, 173, 1) 2.76959deg, rgba(255, 50, 5, 0) 92.9253deg, rgba(255, 240, 224, 0) 205.268deg, rgba(122, 13, 78, 0) 274.405deg, rgba(250, 168, 170, 0.9687) 360deg)', height: '100%', width: '100%', opacity: 1 }}></div>
                        </foreignObject>
                    </g>
                </g>

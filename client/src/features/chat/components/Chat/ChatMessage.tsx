...
const StreamingText = memo(({ text, onComplete, speed = 15 }: StreamingTextProps) => {
...
const ChatMessage = memo(({ message, onActionClick, isLatest = false, onStreamComplete }: ChatMessageProps) => {

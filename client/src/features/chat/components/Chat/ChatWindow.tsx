...
import { sendChatMessage } from '@/features/chat/api/chatService';
...
const ChatWindow = ({ onClose }: ChatWindowProps) => {
    ...
    const [messages, setMessages] = useState<any[]>(() => {
        try {
            ...
            if (saved) {
                ...
                return JSON.parse(saved).map((msg: any) => ({ ...msg, isStreamed: true }));
            }
            return [];
        } catch {
            return [];
    ...
    const handleSendMessage = useCallback(async (directText: string | null = null) => {
        ...
        try {
            ...
            // Handle both response structures: { data: {...} } or direct response
            const chatData = response?.data || response || {};

            // Track chat message with detected intent
            trackEvent.chatMessage({
                message: messageText,
                intent: chatData.intent || detectIntent(messageText),
            ...
            const botMessage = {
                ...
                suggestedAction: chatData.suggested_action || null,
                storeLocation: chatData.store_location || null,
    ...
    const handleActionClick = useCallback((messageId: string, action: string, actionData: any) => {
    ...
    const markMessageAsStreamed = useCallback((messageId: string) => {
        setMessages(prev => prev.map((msg: any) =>
            msg.id === messageId
                ? { ...msg, isStreamed: true }
                : msg
                ...
                <div className={styles.header}>
                    <div className={styles.model}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="8" viewBox="0 0 13 8" fill="none">
                            <path d="M1.04297 1.04175L6.04297 6.04175L11.043 1.04175" stroke="#686868" strokeWidth="2.08333" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                    <div className={styles.button}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                            <path d="M1 1H1.9375V1.9375H1V1ZM8.03125 1H8.96875V1.9375H8.03125V1ZM15.0625 1H16V1.9375H15.0625V1ZM15.0625 8.03125H16V8.96875H15.0625V8.03125ZM15.0625 15.0625H16V16H15.0625V15.0625ZM8.03125 8.03125H8.96875V8.96875H8.03125V8.03125ZM8.03125 15.0625H8.96875V16H8.03125V15.0625ZM1 8.03125H1.9375V8.96875H1V8.03125ZM1 15.0625H1.9375V16H1V15.0625Z" stroke="#686868" strokeWidth="2" strokeLinecap="square" />
                        </svg>
                        ...
                        <div className={styles.prompts} ref={promptsRef}>
                            <div className={styles.row}>
                                <div className={`${styles.prompt} promptItem`} onClick={() => handlePromptClick('Track my orders')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 16 22" fill="none">
                                        <path d="M3.08333 16.1346H9.30556M3.08333 12.2885H12.4167M3.08333 8.44231H12.4167M3.86111 2.28846H0.75V20.75H14.75V2.28846H11.6389M3.86111 0.75H11.6389L10.6667 3.82692H4.83333L3.86111 0.75Z" stroke="#5B947D" strokeWidth="1.5" strokeLinejoin="round" />
                                    </svg>
                                    <p>Track orders</p>
                                </div>
                            ...
                            <div className={styles.row}>
                                ...
                                <div className={`${styles.prompt} promptItem`} onClick={() => handlePromptClick('What payment methods do you accept?')}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="15" viewBox="0 0 22 22" fill="none">
                                        <path d="M11 21C16.523 21 21 16.523 21 11C21 5.477 16.523 1 11 1C5.477 1 1 5.477 1 11C1 16.523 5.477 21 11 21Z" stroke="#FB998E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M14 7.5C13.315 6.815 12.109 6.339 11 6.309M11 6.309C9.68 6.273 8.5 6.87 8.5 8.5C8.5 11.5 14 10 14 13C14 14.711 12.536 15.446 11 15.391M11 6.309V4.5M8 14C8.644 14.86 9.843 15.35 11 15.391M11 15.391V17.5" stroke="#FB998E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                    <p>Payment options</p>
                                </div>
            ...
            <div className={styles.bottom}>
                ...
                <div className={styles.actions}>
                    <div className={styles.action}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="15" viewBox="0 0 22 22" fill="none">
                            <path d="M11 1V21M6 7.25V14.75M21 8.5V13.5M1 8.5V13.5M16 4.75V17.25" stroke="#686868" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <p>Voice mode</p>
                    </div>

...
import { onPreloaderComplete } from '@/core/lib/preloader';
        ...
        <div ref={heroRef} className={`${styles.hero} container`}>
            ...
            <div className={styles.content}>
                <div className={styles.firstRow}>
                    <h1 className={`splitHero ${isAnimFinished ? 'visible' : ''}`}>UPGRADE</h1>
                </div>
                <div className={styles.secondRow}>
                    <h1 className={`splitHero ${isAnimFinished ? 'visible' : ''}`}>YOUR STYLE</h1>
                </div>
                <div className={styles.thirdRow}>
                    <div className={styles.text}>
                        <h1 className={`splitHero ${isAnimFinished ? 'visible' : ''}`}>WITH</h1>
                    ...
                    <button ref={buttonRef} className={`${styles.shopButton} ${isAnimFinished ? styles.visible : ''}`}>
                        <span>SHOP NOW</span>

...
const SelectSize = ({ isOpen, onClose, variants = [], currentVariant: _currentVariant = null, product: _product = null, onAddToCartSuccess }: SelectSizeProps) => {
    ...
    const sizeInfo = variants.reduce((acc: any, variant: any) => {
    ...
    const sortedSizes = Object.values(sizeInfo).sort((a: any, b: any) => {
    ...
    const handleSizeSelect = (sizeData: any) => {
        if (sizeData.inStock) {

 ...
 * 
 * @param {number} snowflakeCount - Number of snowflakes (default: 50)
 * @param {number} speed - Fall speed multiplier (default: 1)
 * @param {number} minSize - Minimum snowflake size in px (default: 10)
 * @param {number} maxSize - Maximum snowflake size in px (default: 25)
...
const Snowfall = memo(({
    ...
    useGSAP(() => {
        ...
        flakes.forEach(flake => {
            ...
            // Calculate fall distance based on container height
            const totalFallDistance = containerHeight + size * 2;

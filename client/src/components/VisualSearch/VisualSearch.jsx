...
import { fileToBase64, findSimilarProducts } from '../../services/imageSearchService';
...
const VisualSearch = ({ isOpen, onClose }) => {
    ...
    const handleFileUpload = useCallback(async (file) => {
        ...
        try {
            ...
            // Call API to find similar products
            console.log('🔍 Searching for similar products...');
            const result = await findSimilarProducts(base64Image, 12);
    ...
    return (
        <>
            ...
            <div className={styles.visualSearchContainer} data-lenis-prevent>
                ...
                <div
                    className={`${styles.input} ${isDragging ? styles.dragging : ''} ${isUploading ? styles.uploading : ''}`}
                    onClick={handleClick}

...
class ChatbotAnalyticsService {
     ...
     */
    async getChatbotDashboard(days = 7) {
        const [
            overview,
            customerTypes,
            intents,
            ...
            this.getChatbotOverview(days),
            this.getCustomerTypeDistribution(days),
            this.getIntentDistribution(days),
            this.getPersonalizationEffectiveness(days),
            this.getDailyUsageTrend(days),
            this.getTopChatProducts(days, 5),
            this.getChatbotConversionMetrics(days)
        ]);
     ...
     */
    async getChatbotOverview(days = 7) {
        try {
     ...
     */
    async getCustomerTypeDistribution(days = 7) {
        try {
            const startDate = new Date();
            startDate.setDate(startDate.getDate() - days);
     ...
     * @param {Number} days - Number of days to analyze
     */
    async getIntentDistribution(days = 7) {
        try {
            const startDate = new Date();
            startDate.setDate(startDate.getDate() - days);
     ...
     * @param {Number} days - Number of days to analyze
     */
    async getPersonalizationEffectiveness(days = 7) {
        try {
            const startDate = new Date();
            startDate.setDate(startDate.getDate() - days);
     ...
     * @param {Number} days - Number of days to analyze
     */
    async getDailyUsageTrend(days = 7) {
        try {
            const startDate = new Date();
            startDate.setDate(startDate.getDate() - days);
     ...
     */
    async getTopChatProducts(days = 7, limit = 10) {
        try {
            const startDate = new Date();
            startDate.setDate(startDate.getDate() - days);
     ...
     * @param {Number} days - Number of days to analyze
     */
    async getChatbotConversionMetrics(days = 7) {
        try {
            const startDate = new Date();
            startDate.setDate(startDate.getDate() - days);
...
export default new ChatbotAnalyticsService();
